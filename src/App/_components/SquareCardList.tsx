...
import SnippetSquareCard, { ISnippetSquareProps } from './SnippetSquareCard'
...
const SquareCardList: SFC<IProps> = props => {
    return (
        <Wrapper>
            {props.items.map((x, i) => (
                <SnippetSquareCard {...x} key={i} />
            ))}
        </Wrapper>
    )
}
